    ...
    <div className="bg-black pb-40 pt-20 xl:pb-[200px] xl:pt-[130px]">
      <MaxWidthWrapper>
        <div className="grid grid-cols-1 items-center gap-14 md:grid-cols-[minmax(0,_1fr)_1.4fr]">
          {/* Image */}
          <div className="jos order-2 overflow-hidden rounded-[20px] md:order-1">
            <img
          ...
          <div className="order-1 md:order-2">
            ...
            <ul className="mt-10 flex flex-col gap-6 font-secondary text-[30px] tracking-[1.33] lg:mt-14 lg:gap-y-3 xl:mt-[70px]">
              ...
              <li className="flex flex-col gap-x-2 leading-tight text-red-500 lg:flex-row lg:leading-normal font-bold font-secondary items-center">
                Phone:
